...
library(ggplot2)      
library(pheatmap)  
load("Microarray_analysis.RData")
...
pdf("Plots/heatmap_plot.pdf", width = 2000, height = 1500, res = 300)
# Save heatmap as PNG
...
graphics.off()  # closes all devices safely
dev.new()       # reopens a fresh one
